...
%  activate=pageopen,
%  addresource=test.gif,
%]{}{test.gif}
\movie[duration=20s,loop,showcontrols=true,height = 0.6 \textwidth,width = 0.8 \textwidth]{\includegraphics[width=0.8\textwidth]{ses_0.png}}{test.mp4}
