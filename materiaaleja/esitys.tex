...
\movie[duration=20s,loop,showcontrols=true,height = 0.5 \textwidth,width = 0.8 \textwidth]{\includegraphics[width=0.8\textwidth, height = 0.5 \textwidth]{2D.jpg}}{2D.mp4}
...
\movie[duration=20s,loop,showcontrols=true,height = 0.5 \textwidth,width = 0.8 \textwidth]{\includegraphics[width=0.8\textwidth, height = 0.5 \textwidth]{2D_dense.jpg}}{2D_dense.mp4}
...
\movie[duration=20s,loop,showcontrols=true,height = 0.5 \textwidth,width = 0.8 \textwidth]{\includegraphics[width=0.8\textwidth, height = 0.5 \textwidth]{2D_rod.jpg}}{2D_rod.mp4}
