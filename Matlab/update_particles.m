function [ locations, velocities, hVals ] = update_particles( locations, velocities, hVals, tStep,m,kappa,gamma,hConst )

% Calculate accelerations on the current step
[accelerations,temp_hVals] = acceleration_total(locations, ...
    velocities,hVals,m,kappa,gamma,tStep,hConst);
...
[accelerations,hVals] = acceleration_total(temp_locations, ...
    temp_velocities,temp_hVals,m,kappa,gamma,tStep,hConst);
%display(hVals);
% Final step values
